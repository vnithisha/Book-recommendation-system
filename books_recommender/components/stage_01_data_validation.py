...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ...
            # Lets rename some columns name in books
            ...
            # Lets rename some columns name in ratings
            ...
            pickle.dump(final_rating,
                        open(os.path.join(self.data_validation_config.serialized_objects_dir, "final_rating.pkl"),
                             'wb'))
            logging.info(
